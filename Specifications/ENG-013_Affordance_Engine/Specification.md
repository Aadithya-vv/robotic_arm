# ENG-013 — Affordance Engine Specification
...
| Engine | ENG-013 — Affordance Engine |
...
Infer capabilities of objects. This specification refines the catalogue responsibility into an implementation-reviewable behavioral boundary without selecting algorithms, concrete APIs, or concrete dependencies.

## 2. Scope

The Engine accepts its approved architectural inputs, validates them, performs the responsibilities owned by ENG-013, returns explicit outcomes, and exposes sufficient lifecycle and diagnostic information for deterministic coordination and review.
...
**Primary input:** Semantic inventory plus approved knowledge/reasoning context.
...
**Primary output:** Contextual object capability and affordance descriptions.
...
**Contract relationships for engineering:** Semantic Inventory, Knowledge, Configuration, and Logging contracts.
...
This Engine does not own object detection, knowledge persistence, goal selection, plan generation, or TaskIR compilation. It shall not bypass another architectural layer, duplicate another Engine's decision authority, or absorb convenience behavior outside its catalogue responsibility.
...
**Draft state model:** Idle>Validating>Reasoning>Completed|InsufficientContext|Failed; terminal result>Idle.
...
| Engine purpose/responsibilities | ABP-04 ENG-013 |

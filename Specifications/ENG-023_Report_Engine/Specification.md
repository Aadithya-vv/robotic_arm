# ENG-023 — Runtime Reporting Engine Specification
...
| Engine | ENG-023 — Runtime Reporting Engine |
...
Generate runtime reports from approved runtime information. This specification refines the catalogue responsibility into an implementation-reviewable behavioral boundary without selecting algorithms, concrete APIs, or concrete dependencies.

## 2. Scope

The Engine accepts its approved architectural inputs, validates them, performs the responsibilities owned by ENG-023, returns explicit outcomes, and exposes sufficient lifecycle and diagnostic information for deterministic coordination and review.

## 3. Responsibilities

- Produce runtime operation reports.
- Produce runtime execution summaries.
- Produce runtime analysis reports.

Each responsibility is exclusive to this Engine at the ownership level defined by ABP-04.

## 4. Inputs

**Primary input:** Approved runtime-report request and authoritative runtime records.
...
**Primary output:** Human-readable runtime report artifact or explicit generation failure.
...
**Approved contract relationships:** Logging, Replay, Execution, and other approved runtime-record providers supply runtime information; ENG-024 may export completed runtime reports.
...
This Engine does not own engineering specifications, Framework Prompts, Implementation Reports, architecture reports, repository status, source-of-truth ownership, runtime logging, or artifact export. Engineering workflow reports remain outside runtime architecture. It shall not bypass another architectural layer, duplicate another Engine's decision authority, or absorb convenience behavior outside its catalogue responsibility.
...
**Draft state model:** Idle>Collecting>Generating>Validating>Completed|Failed; result>Idle.
...
| Engine purpose/responsibilities | ABP-04 ENG-023 |

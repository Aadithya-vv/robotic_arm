# ENG-021 — Demonstration Engine Specification
...
| Engine | ENG-021 — Demonstration Engine |
...
Manage human demonstrations. This specification refines the catalogue responsibility into an implementation-reviewable behavioral boundary without selecting algorithms, concrete APIs, or concrete dependencies.

## 2. Scope

The Engine accepts its approved architectural inputs, validates them, performs the responsibilities owned by ENG-021, returns explicit outcomes, and exposes sufficient lifecycle and diagnostic information for deterministic coordination and review.
...
**Primary input:** User demonstration lifecycle actions and observation references.
...
**Primary output:** Validated demonstration data and workflow status delivered to ENG-015.
...
**Approved contract relationships:** Camera, Dashboard, Event Bus, and Logging support demonstration workflow; validated demonstration data is delivered to ENG-015.
...
This Engine does not own camera capture internals, object detection, task-intent understanding, temporal intent inference, or planning. ENG-015 owns task-intent understanding. It shall not bypass another architectural layer, duplicate another Engine's decision authority, or absorb convenience behavior outside its catalogue responsibility.
...
**Draft state model:** Idle>Preparing>Recording>Validating>Completed|Rejected|Failed; terminal>Idle.
...
| Engine purpose/responsibilities | ABP-04 ENG-021 |

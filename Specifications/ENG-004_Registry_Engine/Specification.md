# ENG-004 — Registry Engine Specification
...
| Engine | ENG-004 — Registry Engine |
...
Maintain Engine registration. This specification refines the catalogue responsibility into an implementation-reviewable behavioral boundary without selecting algorithms, concrete APIs, or concrete dependencies.

## 2. Scope

The Engine accepts its approved architectural inputs, validates them, performs the responsibilities owned by ENG-004, returns explicit outcomes, and exposes sufficient lifecycle and diagnostic information for deterministic coordination and review.
...
**Primary input:** Engine metadata and lookup/resolution request.
...
**Primary output:** Registry view or dependency resolution result.
...
**Contract relationships for engineering:** Configuration and Logging contracts; Engine public contract metadata.
...
This Engine does not own Engine lifecycle coordination, concrete construction policy, or event routing. It shall not bypass another architectural layer, duplicate another Engine's decision authority, or absorb convenience behavior outside its catalogue responsibility.
...
**Draft state model:** Empty>AcceptingRegistrations>Ready; Ready>Resolving>Ready|Degraded; any active state>Closed.
...
| Engine purpose/responsibilities | ABP-04 ENG-004 |

# ENG-011 — Semantic Inventory Engine Specification
...
| Engine | ENG-011 — Semantic Inventory Engine |
| Domain | Perception |
| Version | 1.0 |
...
Transform scene information into semantic entities. This specification refines the catalogue responsibility into an implementation-reviewable behavioral boundary without selecting algorithms, concrete APIs, or concrete dependencies.

## 2. Scope

The Engine accepts its approved architectural inputs, validates them, performs the responsibilities owned by ENG-011, returns explicit outcomes, and exposes sufficient lifecycle and diagnostic information for deterministic coordination and review.
...
**Primary input:** Consistent scene description.
...
**Primary output:** Semantic inventory containing entities, identities, and relationships.
...
**Contract relationships for engineering:** Scene output contract, Knowledge context contract subject to review, and Logging.
...
This Engine does not own visual detection, long-term knowledge ownership, affordance decisions, or task planning. It shall not bypass another architectural layer, duplicate another Engine's decision authority, or absorb convenience behavior outside its catalogue responsibility.
...
**Draft state model:** Empty>Building>Available; Available>Updating>Available|Invalid; Available>Closed.
...
| Engine purpose/responsibilities | ABP-04 ENG-011 |

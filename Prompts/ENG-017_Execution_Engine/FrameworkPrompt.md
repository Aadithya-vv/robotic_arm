# Framework Prompt — ENG-017 Execution Engine
...
| Specification | Specifications/ENG-017_Execution_Engine/Specification.md |

## Mission

Implement only ENG-017 — Execution Engine. Its architectural purpose is: Execute validated TaskIR.
...
- Validate TaskIR and its matching Approval Token issued by ENG-020, then schedule execution; never create approval.
- Schedule execution.
...
- Implementation/ENG-017_Execution_Engine/Source/
- Tests/ENG-017_Execution_Engine/
- Documentation/ENG-017_Execution_Engine/
- Reports/ENG-017_Execution_Engine/ImplementationReport.md

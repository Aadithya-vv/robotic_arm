# Framework Prompt — ENG-015 Planner Engine
...
| Specification | Specifications/ENG-015_Planner_Engine/Specification.md |

## Mission

Implement only ENG-015 — Planner Engine. Its architectural purpose is: own task-intent understanding and generate Semantic Plans for ENG-014.
...
- Interpret demonstrated task intent and goals from validated demonstration data.
- Build Semantic Plans under Contracts/SharedContracts.md; do not generate TaskIR.
...
- Implementation/ENG-015_Planner_Engine/Source/
- Tests/ENG-015_Planner_Engine/
- Documentation/ENG-015_Planner_Engine/
- Reports/ENG-015_Planner_Engine/ImplementationReport.md

# Framework Prompt — ENG-014 TaskIR Compiler Engine
...
Implement only ENG-014 — TaskIR Compiler Engine. Its architectural purpose is: Transform validated plans into TaskIR.
...
3. Read this Engine's Implementation Ready specification completely and Contracts/TaskIRContract.md.
...
- Compile the validated Semantic Plan from ENG-015 into TaskIR.
- Validate TaskIR under Contracts/TaskIRContract.md without performing planning.
...
- Implementation/ENG-014_TaskIR_Compiler_Engine/Source/
- Tests/ENG-014_TaskIR_Compiler_Engine/
- Documentation/ENG-014_TaskIR_Compiler_Engine/
- Reports/ENG-014_TaskIR_Compiler_Engine/ImplementationReport.md

# Framework Prompt — ENG-023 Runtime Reporting Engine
...
| Specification | Specifications/ENG-023_Report_Engine/Specification.md |

## Mission

Implement only ENG-023 — Runtime Reporting Engine. Its architectural purpose is: Generate runtime reports from approved runtime information only.
...
- Produce runtime operation reports; never generate engineering Implementation Reports.
...
- Implementation/ENG-023_Report_Engine/Source/
- Tests/ENG-023_Report_Engine/
- Documentation/ENG-023_Report_Engine/
- Reports/ENG-023_Report_Engine/ImplementationReport.md
